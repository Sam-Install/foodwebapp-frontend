...
const dishes = [
  { id: 1,  image: f1, title: 'Garden Fresh Salad',  description: 'Crispy greens, cherry tomatoes, cucumber and house vinaigrette.',            price: 450, category: 'Salad'    },
  { id: 2,  image: f2, title: 'Chicken Kati Roll',   description: 'Spiced grilled chicken wrapped in a soft flaky paratha with mint chutney.',  price: 620, category: 'Rolls'    },
  { id: 3,  image: f3, title: 'Chocolate Lava Cake', description: 'Warm chocolate cake with a gooey molten centre, served with vanilla cream.', price: 580, category: 'Dessert'  },
  { id: 4,  image: f4, title: 'Club Sandwich',       description: 'Triple-decker toasted sandwich with chicken, egg, lettuce and tomato.',      price: 530, category: 'Sandwich' },
  { id: 5,  image: f5, title: 'Red Velvet Cake',     description: 'Moist red velvet layers with cream cheese frosting and a hint of cocoa.',    price: 700, category: 'Cake'     },
  { id: 6,  image: f6, title: 'Pure Veg Thali',      description: 'A wholesome platter of dal, sabzi, rice, roti, salad and pickle.',          price: 490, category: 'Pure Veg' },
  { id: 7,  image: f7, title: 'Creamy Pasta',        description: 'Penne in a rich roasted tomato and basil cream sauce with parmesan.',        price: 650, category: 'Pasta'    },
  { id: 8,  image: f8, title: 'Stir Fry Noodles',   description: 'Wok-tossed egg noodles with fresh vegetables and a savory soy glaze.',       price: 560, category: 'Noodles'  },
]
